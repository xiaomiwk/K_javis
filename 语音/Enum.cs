...
namespace 语音
{
    ...
    {
        /// <summary>
        /// 音频还没取完，还有后继的音频 MSP_TTS_FLAG_STILL_HAVE_DATA
        /// </summary>
        进行中 = 1,
        /// <summary>
    ...
    {
        /// <summary>
        /// 第一块音频 MSP_AUDIO_SAMPLE_FIRST
        /// </summary>
        第一块 = 0x01,
        /// <summary>
        /// 还有后继音频 MSP_AUDIO_SAMPLE_CONTINUE
        /// </summary>
        中间 = 0x02,
        /// <summary>
        /// 最后一块音频 MSP_AUDIO_SAMPLE_LAST
        /// </summary>
        最后一块 = 0x04,
    }
    ...
    {
        /// <summary>
        /// 还没有检测到音频的前端点 MSP_EP_LOOKING_FOR_SPEECH
        /// </summary>
        等待输入 = 0,          
        /// <summary>
        /// 已经检测到了音频前端点，正在进行正常的音频处理。 MSP_EP_IN_SPEECH
        /// </summary>
        处理中 = 1,                   
        /// <summary>
        /// 检测到音频的后端点，后继的音频会被MSC忽略。 MSP_EP_AFTER_SPEECH
        /// </summary>
        输入完毕 = 3,          
        /// <summary>
        /// 超时 MSP_EP_TIMEOUT
    ...
    {
        /// <summary>
        /// 识别成功，此时用户可以调用QISRGetResult来获取（部分）结果。 MSP_REC_STATUS_SUCCESS
        /// </summary>
        识别成功 = 0,     
        /// <summary>
        /// 识别结束，没有识别结果 // MSP_REC_STATUS_NO_MATCH
        /// </summary>
        没有识别结果 = 1,       
        /// <summary>
        /// 正在识别中 MSP_REC_STATUS_INCOMPLETE
        /// </summary>
        正在识别中 = 2,    
        /// <summary>
        /// 识别结束 MSP_REC_STATUS_COMPLETE
        /// </summary>
        识别结束 = 5, 
    }
    #endregion
